...
<div class="bg-gray-900 text-white py-12">
    <div class="container mx-auto px-4 flex flex-col md:flex-row gap-8">
        <div class="md:w-2/3">
            ...
            <p class="text-lg text-gray-300 mb-6">{{ Str::limit($course->description, 150) }}</p>
    ...
    <div class="md:w-1/3 -mt-32 z-10">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden border dark:border-gray-700 transition-colors">
            <div class="h-48 bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                 ...
                 <a href="{{ route('courses.learn', $course->slug) }}" class="text-center cursor-pointer block hover:opacity-75 transition">
            ...
            <div class="p-6">
                <div class="text-3xl font-bold mb-4 dark:text-white">${{ $course->price }}</div>
                
                @if(auth()->user()->enrolledIn($course))
                    <a href="{{ route('courses.learn', $course->slug) }}" class="block text-center w-full bg-green-600 text-white font-bold py-3 rounded-lg hover:bg-green-700 mb-3 transition">
                        Continue Learning
                    </a>
                @else
                    <a href="{{ route('courses.checkout', $course->slug) }}" class="block text-center w-full bg-blue-600 text-white font-bold py-3 rounded-lg hover:bg-blue-700 mb-3 transition">
                        Add to Cart
                    </a>
                @endif
