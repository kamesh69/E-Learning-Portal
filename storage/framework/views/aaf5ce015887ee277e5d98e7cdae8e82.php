...
<body class="bg-gray-50 text-gray-800 font-sans leading-normal tracking-normal dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300">
    ...
    <nav class="bg-white shadow-md mb-8 dark:bg-gray-800 dark:border-b dark:border-gray-700 transition-colors duration-300">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            <a href="<?php echo e(url('/')); ?>" class="text-2xl font-bold text-blue-600 hover:text-blue-800 transition dark:text-blue-400">
                E-Learning
            </a>
            ...
            <div class="flex items-center space-x-4">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <span class="text-gray-600 dark:text-gray-300">Welcome, <?php echo e(Auth::user()->name); ?></span>
                    
                    <?php if(Auth::user()->role === 'instructor'): ?>
                        <a href="<?php echo e(route('instructor.dashboard')); ?>" class="text-gray-600 dark:text-gray-300 hover:text-blue-600">Dashboard</a>
                    <?php endif; ?>
                    
                     <?php if(Auth::user()->role === 'admin'): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-gray-600 dark:text-gray-300 hover:text-blue-600">Admin</a>
                    <?php endif; ?>
                    
                    <?php if(Auth::user()->role === 'student'): ?>
                         <a href="<?php echo e(route('my-learning')); ?>" class="text-gray-600 dark:text-gray-300 hover:text-blue-600">My Learning</a>
                    <?php endif; ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-gray-600 dark:text-gray-300 hover:text-blue-600">Login</a>
                    <a href="<?php echo e(route('register')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">Get Started</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
    ...
    <footer class="bg-gray-800 text-white py-8 mt-12 dark:bg-gray-950 transition-colors duration-300">
        <div class="container mx-auto px-6 text-center">
            <p>&copy; <?php echo e(date('Y')); ?> E-Learning Platform. All rights reserved.</p>
        </div>
    </footer>
...
<?php /**PATH C:\Users\Kamesh\Desktop\E Learning Platform\resources\views/layouts/app.blade.php ENDPATH**/ ?>