...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-lg shadow-md overflow-hidden hover:shadow-xl transition transform hover:-translate-y-1">
            <a href="<?php echo e(route('courses.show', $course->slug)); ?>" class="block">
                <!-- Thumbnail -->
                <div class="h-48 bg-gray-200 dark:bg-gray-700 w-full object-cover flex items-center justify-center relative">
                    <?php if($course->thumbnail): ?>
                        <img src="<?php echo e(asset($course->thumbnail)); ?>" alt="<?php echo e($course->title); ?>" class="h-full w-full object-cover">
                    <?php else: ?>
                        <span class="text-gray-500 dark:text-gray-400">No Image</span>
                    <?php endif; ?>
                    <span class="absolute top-2 right-2 bg-yellow-400 text-black text-xs font-bold px-2 py-1 rounded"><?php echo e($course->level); ?></span>
                </div>
                
                <div class="p-4">
                    <h3 class="font-bold text-lg mb-1 truncate dark:text-white"><?php echo e($course->title); ?></h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-2">By <?php echo e($course->instructor->name ?? 'Unknown'); ?></p>
                    ...
                    <div class="flex justify-between items-center mt-4">
                        <span class="text-xl font-bold text-gray-900 dark:text-white">$<?php echo e($course->price); ?></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Kamesh\Desktop\E Learning Platform\resources\views/courses/index.blade.php ENDPATH**/ ?>